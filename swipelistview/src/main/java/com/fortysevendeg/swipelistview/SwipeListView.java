...
public class SwipeListView extends ListView {
	...
	protected void onLongClickFrontView(int position) {
		try {
			if (swipeListViewListener != null && position != ListView.INVALID_POSITION) {
				Log.i("LongClick", "Front view long click event is fired");
	...
	public void setSwipeOpenOnLongPress(boolean swipeOpenOnLongPress) {
		touchListener.setSwipeOpenOnLongPress(swipeOpenOnLongPress);
		// touchListener.setSwipeOpenOnLongPress(false);
	}
	...
	public void closeOpenedItemsWithoutAnim(int position) {
		touchListener.closeOpenedItemsWithoutAnim(position);
	}

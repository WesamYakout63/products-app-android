...
//		mListView = new InternalListView(getContext());
		...
		mmListView.setLayoutParams(listParams);
		mmListView.setVerticalScrollBarEnabled(false);
...
//		mmListView.setMode(Mode.PULL_FROM_END);    // mode refresh for top and bottom
//		mmListView.setShowIndicator(false); //disable indicator
//		mmListView.setPullLabel("Loading");
		mmListView.setFadingEdgeLength(0);
//		mmListView.getRefreshableView().setFastScrollEnabled(true);
		// Set a listener to be invoked when the list should be refreshed.
//		mmListView.setOnRefreshListener(new OnRefreshListener<SwipeListView>() {
//			@Override
...
//		mmListView.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
//
//			@Override
...
//		mmListView.getRefreshableView().setOnItemLongClickListener(new OnItemLongClickListener() {
//
//			@Override
...
//		mListView.setSelector(context.getResources().getDrawable(R.drawable.transparent_listview_selector));
		addView(mmListView);
...
//		scrollParams.rightMargin = (int) dpToPx(-20);
...
//	}
	...
	public SwipeListView getListView() {
		return (SwipeListView) mmListView;
	}

	public void addHeaderView(View v) {
//		mmListView.addHeaderView(v);
	}
...
//	protected class InternalListView extends PullToRefreshListView {
//
